  ...
  return (
    <div className="relative group w-full lg:w-[50%] lg:ml-auto transform -translate-y-4">
      ...
      <div className="relative w-full rounded-lg border border-white/60 shadow-[0_40px_80px_-15px_rgba(107,17,88,0.10)] overflow-hidden">
        ...
        <div className="absolute top-4 left-1/2 -translate-x-1/2 z-20 px-2.5 py-0.5 rounded-full bg-ink-100/80 backdrop-blur-sm border border-ink-200/60 whitespace-nowrap">
        ...
        <div className="relative z-10 p-7 md:p-9">
          ...
          <div
            className="mt-6 pt-5 border-t border-ink-100 transition-opacity duration-700"
