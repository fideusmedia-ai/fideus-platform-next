...
export default function Footer({ onLeadClick }: Props) {
  return (
    <footer className="bg-ink-900 text-white relative overflow-hidden">
      <div className="absolute -top-32 -right-32 w-96 h-96 bg-[#E85D2C]/20 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-[#4F46E5]/20 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 md:mb-20">
          <h2 className="text-3xl md:text-5xl font-black tracking-tighter leading-[1.05] mb-5">
            ...
            <span className="font-serif italic font-medium text-transparent bg-clip-text bg-gradient-to-r from-orange-300 via-secondary-300 to-indigo-300">
              negocio
            </span>?
          </h2>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pt-8">
          <p className="text-[11px] font-bold text-white/40 uppercase tracking-widest">
            © {new Date().getFullYear()} Fideus Media · Consultoría Estratégica Integral
          </p>
          <p className="text-[11px] font-bold text-white/40 uppercase tracking-widest">
